<template>
  <section id="platforms" class="py-16 sm:py-20 bg-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-12">
        <h2 class="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
          支持全球 <span class="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">1800+</span> 平台
        </h2>
      ...
      <div class="flex flex-wrap justify-center gap-3 sm:gap-4 max-w-4xl mx-auto">
        <div
          ...
          :key="platform.name"
          class="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-bg-section rounded-full border border-border-light shadow-sm hover:shadow-md hover:border-primary/40 transition-all"
        >
