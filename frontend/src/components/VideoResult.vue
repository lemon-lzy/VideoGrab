        ...
        <div class="border-t border-border-light px-5 sm:px-6 py-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
            ...
            >
              <div class="flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center"
                :class="selectedFormat === fmt.format_id ? 'bg-gradient-to-br from-primary to-accent text-white' : 'bg-gray-100 text-text-muted'">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <div class="mt-6 flex flex-col sm:flex-row items-center gap-3">
            <button
              ...
              class="w-full sm:w-auto inline-flex items-center justify-center gap-2 h-12 px-10 rounded-full text-white font-medium text-base transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg cursor-pointer bg-gradient-to-r from-primary to-accent hover:opacity-90"
            >
