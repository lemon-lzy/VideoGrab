<template>
  <section class="relative overflow-hidden bg-gradient-to-b from-primary-light/60 to-white pt-16 pb-12 sm:pt-24 sm:pb-16">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
      ...
      <h1 class="text-3xl sm:text-5xl font-bold text-text-primary leading-tight mb-4">
        VideoGrab
        <span class="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">，轻松下载</span>
      </h1>
      <p class="text-base sm:text-lg text-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed">
        粘贴视频链接，一键解析下载。支持 YouTube、Bilibili、抖音、TikTok 等主流平台，多种清晰度任你选
      </p>
      ...
      <div class="max-w-2xl mx-auto">
        <form @submit.prevent="onSubmit" class="relative flex items-center">
          ...
          <button
            ...
            class="hidden sm:flex items-center gap-2 h-14 px-8 rounded-r-full text-white font-medium text-base transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg cursor-pointer bg-gradient-to-r from-primary to-accent hover:opacity-90"
          >
          ...
          <button
            type="submit"
            :disabled="loading || !url.trim()"
            class="sm:hidden absolute right-2 top-1/2 -translate-y-1/2 w-9 h-9 flex items-center justify-center rounded-full text-white disabled:opacity-50 cursor-pointer bg-gradient-to-r from-primary to-accent"
          >
